...
backgroundImage = pygame.image.load('prato3.jpg')
...
rockImage = pygame.image.load('sassi1.png')
...
drawText('premi un tasto per iniziare', font, windowSurface, (WINDOWWIDTH / 4) - 50, (WINDOWHEIGHT / 4) + 100)
...
while True:
    ...
    while True:
        ...
        if flowerAddCounter == ADDNEWFLOWERRATE:
            ...
            newFlower = {'rect': pygame.Rect(WINDOWWIDTH, random.randint(300, WINDOWHEIGHT - 90), FLOWERSIZE, FLOWERSIZE),
                        'speed': ROCKSPEED,
        ...
        if rockAddCounter == ADDNEWROCKRATE:
            ...
            newRock = {'rect': pygame.Rect(WINDOWWIDTH, WINDOWHEIGHT - ROCKSIZE, ROCKSIZE, ROCKSIZE),
                        'speed': ROCKSPEED,
