...
pygame.mixer.music.load('correctAnswer.mp3')
pygame.mixer.music.load('music.mp3')
pygame.mixer.music.load('waterAndGlass.mp3')
...
while True:    
    ...
    drawText1('ed evita le sostanze tossiche.', font, windowSurface, (WINDOW_WIDTH / 6), (WINDOW_HEIGHT / 3)+50)
    drawText1('Premi un tasto per iniziare.', font, windowSurface, (WINDOW_WIDTH / 3) - 30, (WINDOW_HEIGHT / 3)+350)
    pygame.display.update()
...
#gioco3
    ...
    while True:
        ...
        if parolaIndovinata.find('_') == -1:
            ...
            drawText(correctAnswer[nCorrectAnswer], fontSmall, windowSurface, 650, WINDOW_HEIGHT/3 + 150)
...
#GIOCO 4
    ...
    drawText1('Ora potrò verificare le tue conoscenze.' ,font, windowSurface, 100,200)
    pygame.display.update()
    waitForPlayerToPressKey()  
    while True:
        ...
        drawText1('SO3 + H2O --->' ,font, windowSurface, 100,200)
        
        risposta =getGuessReazioni()
        pygame.display.update()
        rispostaCorretta=('H2SO4')
        if risposta==rispostaCorretta:
            drawText1(correctAnswer[nCorrectAnswer], font,windowSurface,100, windowSurface.get_rect().centery)
            score = score + 100
            drawText1('Punteggio: ' + str(score), font,windowSurface,100, windowSurface.get_rect().centery + 100)
        else:
            drawText1(wrongAnswer[nWrongAnswer], font, windowSurface,100, windowSurface.get_rect().centery)
            drawText1('Punteggio: '+ str(score), font,windowSurface,100, windowSurface.get_rect().centery + 100)
        pygame.display.update()
        waitForPlayerToPressKey()        
        ...
        drawText1('HCl + NaOH --->' ,font, windowSurface, 100,200)
        ...
        drawText1('AgNO3 + NaCl --->' ,font, windowSurface, 100,200)
        ...
        drawText1('As2S3+H2SO4 --->' ,font, windowSurface, 100,200)
